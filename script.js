...
window.onload = function () {  
    ...
    gui.add(Settings, 'showNormals').onFinishChange(render);
    gui.add(Settings, 'color').listen().onFinishChange(render);
    gui.add(Settings, 'dynamicRefractiveIndex').onFinishChange(render);
    gui.add(Settings, 'refractiveIndex', 1, 10).onFinishChange(onChange);
